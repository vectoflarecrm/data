...
- product_category: SUP, INFLATABLE_SUP, HARD_SUP, TOURING_SUP, ALL_ROUND_SUP, RACE_SUP, YOGA_SUP, KAYAK, INFLATABLE_KAYAK, FISHING_KAYAK, TOURING_KAYAK, RIB_BOAT, INFLATABLE_BOAT, RIB (legacy), PADDLE, PUMP, LIFE_JACKET, WATER_TOY, ACCESSORY, OTHER
- canonical customer-search labels: `RIB_BOAT` = RIB boats; `INFLATABLE_BOAT` = Inflatable boats; `SUP` = SUPs (standup paddleboards).
